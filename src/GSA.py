...
# Prepare output lines for files
    ...
    if args.output_simple:
        simple_lines = ["Variant Name,Expressivity,Quality,Locality,S.P. Types,Syscall Available\r"]
        ...
        orig_metrics = orig_metrics + str(len(original.SyscallGadgets)) + "\r"
    ...
    for key in variants_dict.keys():
        ...
        if args.output_simple:
            ...
            stat_metrics = stat_metrics + str(len(variant.SyscallGadgets))
